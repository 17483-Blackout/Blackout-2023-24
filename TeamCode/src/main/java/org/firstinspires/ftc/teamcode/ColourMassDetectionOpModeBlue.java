...
public class ColourMassDetectionOpModeBlue extends OpMode {
    ...
    @Override
    public void init() {
        Scalar lower = new Scalar(100, 50, 100); // the lower hsv threshold (Maybe 101,50,38)
        Scalar upper = new Scalar(190, 255, 255); // the upper hsv threshold (Maybe 110,255,255)
        double minArea = 50; // the minimum area for the detection to consider something as a prop
...
// code to do if we saw the prop on the left
                break;
            case UNFOUND: telemetry.addLine("Unfound");
